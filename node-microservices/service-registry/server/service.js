...
module.exports = (config) => {
  ...
  service.put("/register/:servicename/:serviceversion/:serviceport",
    (req, res) => {
  ...
  service.delete("/register/:servicename/:serviceversion/:serviceport",
    (req, res) => {
      const { servicename, serviceversion, serviceport } = req.params;
      const serviceip = req.socket.remoteAddress.includes("::") ? `[${req.socket.remoteAddress}]` : req.socket.remoteAddress;
  ...
  service.get("/find/:servicename/:serviceversion",
    (req, res) => {
